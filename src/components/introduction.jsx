                    ...
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          ...
                          <button onClick={this.scrollToGallery} className="btn btn-primary btn-learn" style={{ color: 'black', borderColor: 'black', marginTop: '-30px', marginLeft: '5px' }}>View Gallery <i className="icon-camera" /></button>
                        </div>
                      </div>
                    </div>
                  </div>
